...
HD_PWD='J:/ECEN 323 Labs/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_object.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_object.tcl
