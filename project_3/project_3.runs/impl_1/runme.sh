...
HD_PWD='J:/ECEN 323 Labs/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_object.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_object.tcl -notrace
