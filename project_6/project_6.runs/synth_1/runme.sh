...
HD_PWD='J:/ECEN 323 Labs/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_simple_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_simple_datapath.tcl
