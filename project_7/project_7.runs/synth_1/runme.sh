...
HD_PWD='J:/ECEN 323 Labs/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_single_cycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_single_cycle.tcl
