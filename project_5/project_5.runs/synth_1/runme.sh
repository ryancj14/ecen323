...
HD_PWD='J:/ECEN 323 Labs/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_multdiv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_multdiv.tcl
