...
HD_PWD='J:/ECEN 323 Labs/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_basic_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_basic_pipeline.tcl
