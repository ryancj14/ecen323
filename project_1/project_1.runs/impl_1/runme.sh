...
HD_PWD='J:/ECEN 220 Labs/Lab8_SevenSegmentController/Lab8_SevenSegmentController.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentControlTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegmentControlTop.tcl -notrace
