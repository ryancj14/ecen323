...
HD_PWD='J:/ECEN 220 Labs/Lab8_SevenSegmentController/Lab8_SevenSegmentController.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentControlTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegmentControlTop.tcl
